  ...
  plop.setGenerator('module', {
    ...
    prompts: [
      {
        ...
        validate: (value) => {
          if (/.+/.test(value)) {
            return moduleCheck(modulePath, value)
    ...
    actions: () => [
      ...
      },
      {
        type: 'add',
        path:
          '../lib/modules/{{pascalCase name}}/{{lowerCase name}}.resolver.ts',
      ...
      },
      {
        type: 'add',
        path:
          '../lib/modules/{{pascalCase name}}/dto/{{lowerCase name}}-create.ts',
      ...
      },
      {
        type: 'add',
        path:
          '../lib/modules/{{pascalCase name}}/dto/{{lowerCase name}}-update.ts',
        templateFile: './update.dto.hbs',
        abortOnFail: true,
      },
      {
        type: 'append',
        path: '../lib/utils/server/orm.ts',
      ...
      },
      {
        type: 'append',
        path: '../lib/utils/server/orm.ts',
        pattern: `/* INJECT_NATIVE_DELETE */`,
        template: `DI.{{pascalCase name}}Repository.nativeDelete({});`,
      },
      {
        type: 'append',
